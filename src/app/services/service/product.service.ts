...
const BACKEND_URL = environment.apiURL + 'api/product/';
...
export class ProductService {
  ...
  addProduct(productData: Product): Observable<{ message: string, product: Product }> {
    return this.http.post<{ message: string, product: Product }>(BACKEND_URL + "add-product", productData);
  }

  bulkUpload(productData: Product): Observable<{ message: string, product: Product }> {
    return this.http.post<{ message: string, product: Product }>(BACKEND_URL + "bulk-upload", productData);
  }
