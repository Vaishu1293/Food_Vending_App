...
import { BulkDataComponent } from './forms/bulk-data/bulk-data.component';
...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'ecom-product-grid', component: ProductGridComponent, canActivate: [AuthGuard] },
      { path: 'ecom-product-list', component: ProductListComponent },
      { path: 'ecom-product-detail/:id', component: ProductDetailComponent },
      { path: 'ecom-product-order', component: OrderComponent, canActivate: [AuthGuard] },
      { path: 'ecom-checkout', component: CheckoutComponent, canActivate: [AuthGuard] },
      { path: 'ecom-invoice', component: InvoiceComponent, canActivate: [AuthGuard] },
      { path: 'ecom-customers', component: EcomCustomersComponent, canActivate: [AuthGuard] },
  ...
  { path: 'page-validate-otp', component: ValidateOtpComponent },
  // Error Routes
